...
ubm=$thisdir/models/ubm.gmm
pmsgmm=$thisdir/models/sms.gmms
sgmm=$thisdir/models/s.gmms
ggmm=$thisdir/models/gender.gmms
 
 
LOCALCLASSPATH=$thisdir/lium_spkdiarization-8.4.1.jar
...
$java -classpath "$LOCALCLASSPATH" fr.lium.spkDiarization.tools.PrintSeg --sInputMask=./$datadir/%s.c.$h.seg --sOutputMask=%s.xml --sOutputFormat=seg.xml $show
